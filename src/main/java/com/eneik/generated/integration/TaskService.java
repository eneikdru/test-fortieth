...
public class TaskService {
    ...
    public TaskResolutionResult resolveTasksAndCalculateReadiness() {
        ...
        // Resolve all failed tasks unconditionally to restore stalled progress
        ...
        log.info("Resolved {} out of {} failed tasks unconditionally.", failedResolvedCount, failedTasks.size());
